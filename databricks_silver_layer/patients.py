...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.patients (
...
# MAGIC )
# MAGIC USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/patient';

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Step 1: Mark existing records as historical (is_current = false) for patients that will be updated
# MAGIC MERGE INTO healthcare_insurance.silver.patients AS target
...
# MAGIC %sql
# MAGIC select count(*),Patient_Key from healthcare_insurance.silver.patients
