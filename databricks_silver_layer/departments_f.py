...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.departments (
...
# MAGIC )
# MAGIC USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/departments';

# COMMAND ----------

# MAGIC %sql
# MAGIC insert into healthcare_insurance.silver.departments
# MAGIC SELECT 
# MAGIC Dept_Id,
# MAGIC SRC_Dept_Id,
# MAGIC Name,
