...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.npi_extract (
# MAGIC   npi_id STRING,
...
# MAGIC ) USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/npi_extract';

# COMMAND ----------

# MAGIC %sql
# MAGIC MERGE INTO
# MAGIC   healthcare_insurance.silver.npi_extract AS target
# MAGIC USING
...
# MAGIC %sql
# MAGIC select * from healthcare_insurance.silver.npi_extract
