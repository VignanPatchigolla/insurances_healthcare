...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.icd_codes (
...
# MAGIC )USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/icd_codes';

# COMMAND ----------

# MAGIC %sql
# MAGIC MERGE INTO
# MAGIC   healthcare_insurance.silver.icd_codes AS target
# MAGIC USING
