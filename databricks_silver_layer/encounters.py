...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.encounters (
...
# MAGIC )
# MAGIC USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/encounters';

# COMMAND ----------

# MAGIC %sql
# MAGIC truncate table healthcare_insurance.silver.encounters

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Update old record to implement SCD Type 2
# MAGIC MERGE INTO healthcare_insurance.silver.encounters AS target
...
# MAGIC MERGE INTO healthcare_insurance.silver.encounters AS target USING quality_checks AS source ON target.EncounterID = source.EncounterID
...
# MAGIC %sql
# MAGIC select SRC_EncounterID,datasource,count(patientid) from  healthcare_insurance.silver.encounters
# MAGIC group by all
