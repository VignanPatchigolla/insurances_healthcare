...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare_insurance.silver.cptcodes (
...
# MAGIC )
# MAGIC USING DELTA LOCATION 'abfss://silver@healthinsurance.dfs.core.windows.net/cptcodes';

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Update old record to implement SCD Type 2
# MAGIC MERGE INTO healthcare_insurance.silver.cptcodes AS target
