...
# MAGIC %sql
# MAGIC create table if not exists healthcare_insurance.gold.fact_transactions
# MAGIC (
...
# MAGIC )
# MAGIC USING DELTA LOCATION 'abfss://gold@healthinsurance.dfs.core.windows.net/fact_transactions';

# COMMAND ----------

# MAGIC %sql
# MAGIC truncate table healthcare_insurance.gold.fact_transactions

# COMMAND ----------

# MAGIC %sql
# MAGIC insert into healthcare_insurance.gold.fact_transactions
# MAGIC select 
...
# MAGIC   from healthcare_insurance.silver.transactions t 
# MAGIC   where t.is_current=true and t.is_quarantined=false

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from healthcare_insurance.gold.fact_transactions;
